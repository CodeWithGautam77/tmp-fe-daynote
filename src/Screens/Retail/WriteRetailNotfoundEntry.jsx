...
import WrtieNFStyle from "./WriteRetailNotfoundEntry.module.scss";
...
import { updateCustomerSupplierEntry } from "../../apis/retailSlice";

export default function WriteRetailNotfoundEntry({ forceData, setForceData }) {
  ...
  useEffect(() => {
    if (forceData) {
      ...
      if (forceData.iType === "I") {
        creditDebouncedSearch(forceData.text);
      }
      if (forceData.iType === "E") {
        debitDebouncedSearch(forceData.text);
      }
    }
  }, [forceData]);
            ...
            >
              {isFindEntryWriting && (
                <div className="flex gap-05">
                  ...
                  >
                    {forceData?.text} - {forceData?.amount}
                  </Typography>
                </div>
              )}
              <div
